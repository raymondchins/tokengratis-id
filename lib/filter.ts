...
// `freeinfo` DIBUANG 2026-07-27: dipromosiin jadi chip filter "Ada info
// gratis" di FilterBar. Sort itu cuma ngurut ulang, chip beneran motong —
// dan dua jalan buat satu kerjaan persis inkonsistensi yang lagi dibenerin.
// Sekalian bikin opsi sort balik ke 4, di bawah batas kerja ingatan.
