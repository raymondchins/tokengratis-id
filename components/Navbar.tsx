    ...
    <header className="sticky top-3 z-50 px-4">
      <nav className="mx-auto flex max-w-5xl items-center justify-between gap-4 rounded-full border border-ink-line bg-ink-soft/90 px-3 py-2 pl-5 shadow-[0_8px_30px_rgba(17,24,28,0.06)] backdrop-blur">
        ...
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-serif text-lg font-semibold tracking-tight text-fog">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="hidden rounded-full border border-ink-line bg-ink px-4 py-1.5 text-sm font-medium text-fog transition-colors hover:bg-ink-line/40 sm:inline-block"
          >
            GitHub
          </a>
          <Link
